...
class sonar implements Runnable{
	...
	public static void sonar_calc_simple(int freq){
		...
		//first signal is at t=0, counting difference in time in seconds(or nano)
		//int freq = 35000;//target freq
		Long left_time = (long) 0, right_time =(long) 0, top_time=(long) 0;

		/*while(left_in == 0 || right_in == 0 || top_in == 0){
		Update (right_in, left_in,top_in);//gets time when freq is detected
		}*/
